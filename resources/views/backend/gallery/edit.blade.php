                ...
                <div class="mdc-layout-grid__inner">
                    <div class="mdc-layout-grid__cell--span-12">
                        <div class="mdc-card">
                            ...
                            <form action="{{ route('galleryCategory.update', ['galleryCategory' => $galleryCategory]) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="template-demo">
                                    <div class="mdc-layout-grid__inner">
                                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                                            <div class="mdc-text-field mdc-text-field--outlined">
                                                <input name="name" value="{{ $galleryCategory->name }}" class="mdc-text-field__input" id="text-field-hero-input">
                                        ...
                                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                                            <div class="mdc-text-field mdc-text-field--outlined">
                                                <textarea name="description" class="mdc-text-field__input" rows="10">{{ $galleryCategory->description }}</textarea>
                                                <div class="mdc-notched-outline">
                                                    <div class="mdc-notched-outline__leading"></div>
                                                    <div class="mdc-notched-outline__notch">
