...
@if (filled($rulesValues['hide']))
    <td
        ...
        style="{{ data_get($theme, 'checkbox.thStyle') }}; border:1px solid #b0b0b0; border-collapse: collapse"
    >
    </td>
@elseif(filled($rulesValues['disable']))
    <td
        class="{{ data_get($theme, 'checkbox.tdClass') }}"
        style="{{ data_get($theme, 'checkbox.tdStyle') }}; border:1px solid #b0b0b0; border-collapse: collapse"
    >
