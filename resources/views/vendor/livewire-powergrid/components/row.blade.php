...
@foreach ($columns as $column)
    ...
    <td
        ...
        style="text-align: left;{{ $column->hidden === true ? 'display:none' : '' }}; {{ data_get($theme, 'table.tdBodyStyle'). ' ' . $column->bodyStyle ?? '' }};border:1px solid #b0b0b0; border-collapse: collapse"
