        ...
        <div class="row d-flex align-items-start">
            ...
            <div class="col-md topper d-flex mb-md-0 align-items-xl-center">
                ...
                <div class="text pl-3 pl-md-3">
                    ...
                    <p class="con">UNIT 15, FIRST FLOOR, 65, THE BROADWAY, UB1 1JY </p>
                </div>
            </div>
            <div class="col-md topper d-flex mb-md-0 align-items-xl-center">
                ...
                <div class="text pl-3 pl-md-3">
                    ...
                    <p class="con">
                        <a href="https://www.instagram.com/karanjeeproperties?igshid=ZWQyN2ExYTkwZQ%3D%3D">Instagram</a>
                        <a href="https://api.whatsapp.com/message/5Q2RYDDS2NSCI1?autoload=1&amp;app_absent=0">Whatsapp</a>
                        <a href="https://www.tiktok.com/@karanjeeproperties?_t=8cjTOOvUWMd&amp;_r=1">Tiktok</a></p>
                </div>
            </div>
        </div>
    </div>
